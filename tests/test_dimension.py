...
def test_vector_state_update_delta():
    ...
    old = np.array([0.5, 0.5], dtype=np.float64)
    new = np.array([1.5, -0.5], dtype=np.float64)
...
def test_vector_state_update_modes():
    ...
    uav = np.array([0.5, 1.0, 0.0], dtype=np.float64)
    bav = np.array([1.0, 0.5, 2.0], dtype=np.float64)
...
def test_vector_feasible_check_fast_masked():
    state = np.array([5.0, 2.0, 7.0], dtype=np.float64)
    limit = np.array([6.0, 2.5, 6.5], dtype=np.float64)
